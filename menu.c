...
void initUserVars() {
	...
	seth.vars[VAR_AIMPREDICT] = (ethVars_t) { "Enemy prediction type", qfalse, "epredict", CAT_AIMBOT, qfalse,
		{ { "Off", AIMPREDICT_OFF }, { "Auto", AIMPREDICT_AUTO }, { "Manual", AIMPREDICT_MANUAL } , { "AUTO B", AIMPREDICT_AUTOB }, { "AUTO C", AIMPREDICT_AUTOC },  { "Ping based", AIMPREDICT_AUTO_3 }, { "Acceleration / speed based", AIMPREDICT_AUTO_4 } } };
	...
	//color mixer
	seth.vars[VAR_FRIEND_VISIBLE_BLUE] = (ethVars_t) { "Friend Visible Blue", 20, "friendviscolor_blue", CAT_ESP, 0, { } };
	seth.vars[VAR_FRIEND_VISIBLE_RED] = (ethVars_t) { "Friend Visible Red", 0, "friendviscolor_red", CAT_ESP, 0, { } };
	seth.vars[VAR_FRIEND_VISIBLE_GREEN] = (ethVars_t) { "Friend Visible Green", 200, "friendviscolor_green", CAT_ESP, 0, { } };
	seth.vars[VAR_ENEMY_VISIBLE_BLUE] = (ethVars_t) { "Enemy Visible Blue", 0, "enemyviscolor_blue", CAT_ESP, 0, { } };
	seth.vars[VAR_ENEMY_VISIBLE_RED] = (ethVars_t) { "Enemy Visible Red", 200, "enemyviscolor_red", CAT_ESP, 0, { } };
	seth.vars[VAR_ENEMY_VISIBLE_GREEN] = (ethVars_t) { "Enemy Visible Green", 50, "enemyviscolor_green", CAT_ESP, 0, { } };
	seth.vars[VAR_FRIEND_NOT_VISIBLE_BLUE] = (ethVars_t) { "Friend  Notvisible Blue", 100, "friendnotviscolor_blue", CAT_ESP, 0, { } };
	seth.vars[VAR_FRIEND_NOT_VISIBLE_RED] = (ethVars_t) { "Friend  Notvisible Red", 20, "friendnotviscolor_red", CAT_ESP, 0, { } };
	seth.vars[VAR_FRIEND_NOT_VISIBLE_GREEN] = (ethVars_t) { "Friend  Notvisible Green", 40, "friendnotviscolor_green", CAT_ESP, 0, { } };
	seth.vars[VAR_ENEMY_NOT_VISIBLE_BLUE] = (ethVars_t) { "Enemy  Notvisible Blue", 0, "enemynotviscolor_blue", CAT_ESP, 0, { } };
	seth.vars[VAR_ENEMY_NOT_VISIBLE_RED] = (ethVars_t) { "Enemy  Notvisible Red", 200, "enemynotviscolor_red", CAT_ESP, 0, { } };
	seth.vars[VAR_ENEMY_NOT_VISIBLE_GREEN] = (ethVars_t) { "Enemy  Notvisible Green", 100, "enemynotviscolor_green", CAT_ESP, 0, { } };
	...
	seth.vars[VAR_KSPAM] = (ethVars_t) { "Change Spam", ETH, "spamchange", CAT_MISC, qtrue,
		{ { "eth", ETH }, { "rs1", RS1 }, { "rs2", RS2 }, { "rs3", RS3 }, { "rs4", RS4 }, { "probot", PRO }, { "etbOT", ETB }, { "Aek1", AEK }, { "Aek2", AEK1 }, { "Evo", EVO }, { "Eth3", CEF }, { "eth32", ETH32 }, { "eth2", ETH2 },  { "Nexus", NEX },  { "Pwned", Pwned } } };
...
void drawMenu() {
	...
	for (; catCount < CATS_MAX; catCount++) {
		...
		// Draw category
		drawFillRect(MENU_SCREEN_BORDER, y, maxItemWidth, itemHeight, isMouseOn ? colorBlue : gameBackColor);
		...
		for (; varCount < VARS_TOTAL; varCount++) {
			...
			drawRect(MENU_SCREEN_BORDER, y, maxItemWidth, itemHeight, isMouseOn ? gameBackColor : gameBorderColor, 1);
			drawText(MENU_SCREEN_BORDER + (itemHeight / 2) + sizeTextWidth(MENU_TEXT_SIZE, " ", &eth.fontVariable), y + 2, MENU_TEXT_SIZE, var->menuText, colorWhite, qfalse, qfalse, &eth.fontVariable);
			...
			drawFillRect(MENU_SCREEN_BORDER + MENU_ITEM_SPACE + maxItemWidth, y, maxValueWidth, itemHeight, isMouseOn ? colorYellow : gameBackColor);
			...
			drawText(MENU_SCREEN_BORDER + MENU_ITEM_SPACE + maxItemWidth + (maxValueWidth / 2) - (w / 2), y + 2, MENU_TEXT_SIZE, value, colorCyan, qfalse, qfalse, &eth.fontVariable);
